...
import { ObjectType } from "@pinterest/alloy-graphql";
...
```tsx
import { renderSchema, relayNamePolicy } from "@pinterest/alloy-graphql";
...
```ts
import { createGraphQLNamePolicy, renderSchema } from "@pinterest/alloy-graphql";
...
- `src/components/stc/`: string-template helpers (`@pinterest/alloy-graphql/stc`)
